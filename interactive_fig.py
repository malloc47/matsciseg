...
#        plt.xlim(1,10)
    ...
    syn_clicks = { 'magic' : [210, 148, 146, 123, 182, 170, 164, 122, 131, 137, 149, 143, 160, 135, 171, 145, 131, 120, 129, 127],
                   'magicprop' : [210,13, 14, 21, 36, 20, 26, 28, 38, 47, 40, 45, 50, 38, 46, 40, 52, 31, 31, 32],
                   'proposed' : [210, 1, 1, 4, 7, 5, 6, 5, 4, 8, 8, 13, 8, 14, 21, 13, 9, 21, 19, 12],
                   'propagation' : [210,0,0,0,0,0,0,0,0,0,13,5,11,0,0,0,0,0,0,0],

                   }

    syn_time = { 'magic' : map(to_minutes,[415, 306, 307, 247, 289, 403, 337, 188, 227, 267, 245, 225, 244, 202, 214, 225, 205, 172, 182, 196]),
                 'magicprop' : map(to_minutes,[415,45, 37, 36, 64, 38, 45, 46, 49, 71, 46, 68, 104, 70, 72, 67, 88, 48, 57, 49]),

                 'proposed' : map(to_minutes,[415, 7, 7, 16, 14, 14, 20, 16, 17, 29, 20, 40, 23, 40, 61, 42, 32, 70, 66, 48]),
                 'propagation' : map(to_minutes,[415,0,0,0,0,0,0,0,0,0,42,29,33,0,0,0,0,0,0,0])}
